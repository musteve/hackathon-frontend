...
const GetCurriculumData = async (func: React.Dispatch<React.SetStateAction<Curriculum[]>>) => {
    try {
        ...
        const res: Curriculum[] = await response.json()
...
export default GetCurriculumData
